...
def ordenes(rutinaContable):
    ...
    # factura = list(map(lambda lista: [lista[0]] + list(map(lambda lista: lista[1] * lista[2], lista[1:])),factura))
    # factura = list(map(lambda lista: [lista[0]] + [reduce(lambda x, y: x + y, lista[1:])],factura))
    # factura = list(map(lambda lista: lista if lista[1] >= compraMinima else lista[1] + recargo))
